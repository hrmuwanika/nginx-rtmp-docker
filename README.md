...
* Enter the URL from above as `http://<ip_of_host>:8080/hls/stream_name/index.m3u8` for hls or `http://<ip_of_host>:8080/dash/stream_name/index.mpd` for dash replacing `<ip_of_host>` with the IP of the host in which the container is running and `<key>` with the key you created in OBS Studio. For example: `http://45.99.213.78:8080/hls/stream_name/index.m3u8` for hls or `http://45.99.213.78:8080/dash/stream_name/index.mpd` for dash
* Click "Play"
